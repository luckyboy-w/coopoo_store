<template>
  <div>
      ...
      <div class="ly-table-panel">
        <div class="ly-data-list">
          <el-table
            ...
            <el-table-column prop="couponName" label="礼券名称" width="150px"></el-table-column>
    ...
    <saveOrEdit v-if="showAddOrEdit" @showListPanel="showListPanel" :editData="editData" isGift="2"></saveOrEdit>
  </div>
</template>

<script>
import saveOrEdit from "@/views/coupon/saveOrEdit";
...
export default {
  ...
  methods: {
    ...
    loadList() {
      let scope = this;
      getMethod("/bu/coupon/findPage?isGift=2", this.searchParam).then(res => {
