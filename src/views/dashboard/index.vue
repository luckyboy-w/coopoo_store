        ...
        <router-link to="/bc-goods/reject">
          <div class="card-panel">
            ...
            <div class="card-right">
              <count-to :start-val="0" :end-val="indexData.confirmSettleNum" :duration="2000" />
            </div>
          </div>
        </router-link>
      </div>
      <div class="card-panel-col">
        <router-link to="/bc-goods/saleList">
          <div class="card-panel">
            ...
            <div class="card-right">
              <count-to :start-val="0" :end-val="indexData.waitPickNum" :duration="2000" />
            </div>
          </div>
        </router-link>
      </div>
      ...
      <div class="card-panel-col">
        <router-link to="bc-order/readyPay">
          <div class="card-panel">
            ...
            <div class="card-right">
              <count-to :start-val="0" :end-val="indexData.orderNum" :duration="2000" />
            </div>
          </div>
        </router-link>
      </div>
      <div class="card-panel-col">
        <router-link to="bc-order/readyPay">
          <div class="card-panel">
            ...
            <div class="card-right">
              <count-to :start-val="0" :end-val="indexData.registerMemberNum" :duration="2000" />
            </div>
          </div>
        </router-link>
      </div>
